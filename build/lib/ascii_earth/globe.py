...
# 56 UTF-8 glyphs ordered dark -> dense, weights measured in JetBrains Mono.
# ASCII, geometric shapes and block/shade elements (no alphabets beyond Latin),
# so the surface reads as a busy many-symbol weave rather than a few letters.
UNICODE_RAMP = ' ,-;"^>▏/)[◇rJizc▖*xuf4▮◐◒◗✦❖C□pghXA9dwKHQ0&%N◆▍▝▚▐●▋▀▊▛█'
